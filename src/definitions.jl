...
const UNSET_MAX_ITERATIONS = -1 # SolutionParameters.maxIterations sentinel: resolved to the solver's default at model construction; never a legitimate iteration count
